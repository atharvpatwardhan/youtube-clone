...
export const Navbar = ({sideBar, setSideBar, searchTerm, setSearchTerm}) => {
  ...
  return (
    <div className='w-full flex fixed h-16 z-40 bg-white'>
        ...
        <div className='absolute right-5 top-4'>
            <h1>Made by <span className='text-blue-500'><a href='https://www.linkedin.com/in/atharv-patwardhan/' rel="noreferrer" target='_blank'>Atharv Patwardhan</a></span></h1>
        </div>
    </div>
  )
}
