...
export const SearchResults = ({videos,setVideos,searchTerm,setSearchTerm}) => {
              ...
              <div className='m-5 cursor-pointer'>
                {video.id.channelId
                 ...
                 <div className='flex items-center gap-10'>
                  <img src={video?.snippet.thumbnails.high.url} alt='channel image' className='rounded-full h-52 w-52' />
                  <div>
