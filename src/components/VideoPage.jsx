        ...
        <div className='md:ml-72 flex flex-col md:grid md:grid-cols-2'>
            <div>
                ...
                <div className='flex items-center gap-5 my-5'>
                    <img src={channel?.snippet.thumbnails.high.url} alt='thumbnail' className='rounded-full w-12 h-12 cursor-pointer' />
                    <div>
                        ...
                        comments?.map((comment) => (
                            <div className='my-7'>
                                <div className='flex items-center gap-2'>
                                    <img className='rounded-full w-12 h-12' src={comment.snippet.topLevelComment.snippet.authorProfileImageUrl} alt='comment' />
